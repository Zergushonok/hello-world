...
public class TradeOrder implements Order {
  ...
  private TradeOrder(Client client, Order.Type type, Asset asset, int price, int quantity) {
    this.client = client;
    this.type = type;
    this.asset = asset;
    this.price = price;
  ...
  public static TradeOrder of(Client client, Order.Type type, Asset asset,
